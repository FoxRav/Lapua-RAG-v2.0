...
class LapuaQueryAgent:
    ...
    def answer(self, plan: LapuaQueryPlan, results: List[SearchResult]) -> LapuaAnswer:
        ...
        system_prompt = (
            ...
            "🚫 EHDOTTOMAT KIELLOT (riko näitä = virheellinen vastaus):\n"
            "1. ÄLÄ KOSKAAN keksi tai arvaa tietoa\n"
            "2. ÄLÄ KOSKAAN käytä yleistietoa tai ulkopuolista tietämystä\n"
            "3. ÄLÄ KOSKAAN mainitse päivämäärää/pykälää jota EI ole lähteissä\n"
            "4. ÄLÄ KOSKAAN oleta mitä 'todennäköisesti' tapahtui\n\n"
            "✅ PAKOLLISET SÄÄNNÖT:\n"
            "1. JOKAINEN väite TÄYTYY löytyä SANASTA SANAAN lähteistä\n"
            "2. Jos tietoa EI löydy → vastaa: 'Tätä tietoa ei löydy annetuista pöytäkirjoista.'\n"
            "3. Viittaa AINA: Toimielin, pp.kk.vvvv, § X\n"
            "4. Mieluummin lyhyt ja oikea vastaus kuin pitkä ja epävarma\n\n"
            "VASTAUSMUOTO:\n"
            "**Lyhyt yhteenveto** (2-3 virkettä, perustuen lähteisiin)\n\n"
            "**Keskeiset päätökset**\n"
            "- **Toimielin, pp.kk.vvvv, § X** – Mitä päätettiin.\n\n"
            "MUOTOILU: EI taulukoita, käytä luetteloita, jokainen pykälä vain kerran."
            f"{broad_guidance}"
        )
